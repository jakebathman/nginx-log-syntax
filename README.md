...
1. Open an NGINX access.log file in VS Code, or paste a few log lines in an empty tab.
2. In the Command Palette, select `Change Langauge Mode`, then `NGINX Log`. You can also change the syntax in the lower-right menu.
